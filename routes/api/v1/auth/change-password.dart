...
Future<Response> onRequest(RequestContext context) async {
  ...
  final validationErrors = AuthValidators.validateChangePasswordBody(body);
  ...
  final oldPassword = (body['oldPassword'] as String).trim();
  ...
  if (!TokenService.verifyPassword(oldPassword, user.hashedPassword ?? '')) {
    return Response.json(
